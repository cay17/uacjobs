 ...
 */
class getGaleryRepositoryService extends App_KernelGhujDebugContainer
{
    /**
     * Gets the private 'App\Repository\GaleryRepository' shared autowired service.
     *
     * @return \App\Repository\GaleryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GaleryRepository.php';

        return $container->privates['App\\Repository\\GaleryRepository'] = new \App\Repository\GaleryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
