 ...
 */
class getPodcastRepositoryService extends App_KernelGhujDebugContainer
{
    /**
     * Gets the private 'App\Repository\PodcastRepository' shared autowired service.
     *
     * @return \App\Repository\PodcastRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PodcastRepository.php';

        return $container->privates['App\\Repository\\PodcastRepository'] = new \App\Repository\PodcastRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
