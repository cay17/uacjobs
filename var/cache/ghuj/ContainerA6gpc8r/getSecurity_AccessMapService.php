 ...
 */
class getSecurity_AccessMapService extends App_KernelGhujDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/etudiant'), [0 => 'ROLE_ETUDIANT'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/recruteur'), [0 => 'ROLE_RECRUTEUR'], NULL);
