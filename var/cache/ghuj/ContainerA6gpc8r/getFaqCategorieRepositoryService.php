 ...
 */
class getFaqCategorieRepositoryService extends App_KernelGhujDebugContainer
{
    /**
     * Gets the private 'App\Repository\FaqCategorieRepository' shared autowired service.
     *
     * @return \App\Repository\FaqCategorieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FaqCategorieRepository.php';

        return $container->privates['App\\Repository\\FaqCategorieRepository'] = new \App\Repository\FaqCategorieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
