...
class getWebpackEncore_EntrypointLookup_CacheWarmerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] = new \Symfony\WebpackEncoreBundle\CacheWarmer\EntrypointCacheWarmer(['_default' => (\dirname(__DIR__, 4).'/public/build/entrypoints.json')], (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/webpack_encore.cache.php'), ($container->privates['cache.webpack_encore'] ?? $container->load('getCache_WebpackEncoreService')));
    }
}
