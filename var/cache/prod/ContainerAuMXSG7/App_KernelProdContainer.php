...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\cmsController' => 'getCmsControllerService',
            'App\\Controller\\etudiantController' => 'getEtudiantControllerService',
            'App\\Controller\\frontController' => 'getFrontControllerService',
            'App\\Controller\\recruteurController' => 'getRecruteurControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gedmo'.\DIRECTORY_SEPARATOR.'doctrine-extensions'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Gedmo'.\DIRECTORY_SEPARATOR.'Mapping'.\DIRECTORY_SEPARATOR.'MappedEventSubscriber.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gedmo'.\DIRECTORY_SEPARATOR.'doctrine-extensions'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Gedmo'.\DIRECTORY_SEPARATOR.'Sluggable'.\DIRECTORY_SEPARATOR.'SluggableListener.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gedmo'.\DIRECTORY_SEPARATOR.'doctrine-extensions'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Gedmo'.\DIRECTORY_SEPARATOR.'AbstractTrackingListener.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gedmo'.\DIRECTORY_SEPARATOR.'doctrine-extensions'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Gedmo'.\DIRECTORY_SEPARATOR.'Timestampable'.\DIRECTORY_SEPARATOR.'TimestampableListener.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Metadata'.\DIRECTORY_SEPARATOR.'Property'.\DIRECTORY_SEPARATOR.'Factory'.\DIRECTORY_SEPARATOR.'InheritedPropertyNameCollectionFactory.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Metadata'.\DIRECTORY_SEPARATOR.'Property'.\DIRECTORY_SEPARATOR.'Factory'.\DIRECTORY_SEPARATOR.'InheritedPropertyMetadataFactory.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Filter'.\DIRECTORY_SEPARATOR.'QueryParameterValidateListener.php';
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setProxyDir((\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/doctrine/orm/Proxies'));
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\FaqCategorieRepository' => ['privates', 'App\\Repository\\FaqCategorieRepository', 'getFaqCategorieRepositoryService', true],
            'App\\Repository\\FaqRepository' => ['privates', 'App\\Repository\\FaqRepository', 'getFaqRepositoryService', true],
            'App\\Repository\\GaleryRepository' => ['privates', 'App\\Repository\\GaleryRepository', 'getGaleryRepositoryService', true],
            ...
            'App\\Repository\\NewsletterMessageRepository' => ['privates', 'App\\Repository\\NewsletterMessageRepository', 'getNewsletterMessageRepositoryService', true],
            ...
            'App\\Repository\\FaqCategorieRepository' => '?',
            'App\\Repository\\FaqRepository' => '?',
            'App\\Repository\\GaleryRepository' => '?',
            'App\\Repository\\MediaObjectRepository' => '?',
            'App\\Repository\\MessageRepository' => '?',
            'App\\Repository\\NewsletterMessageRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\ResolveMediaObjectContentUrlSubscriber'] ?? $this->load('getResolveMediaObjectContentUrlSubscriberService'));
        }, 1 => 'onPreSerialize'], 17);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+HNvenyYpd', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ei3eNRoQMN', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+3Hg3Ok8n3', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Qe2NkvWpnj', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KNkxZwzuqy', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('U59K8V52rC', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ximb6HWR0a', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DOCjwaGjD6', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rVjqO8rffy', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Zevowyv9Bo', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pwwKBFYCCy', 0, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LSiiMV+9N9', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setMappingCache(\Symfony\Component\Cache\Adapter\PhpArrayAdapter::create((\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/validation.php'), ($this->privates['cache.validator'] ?? $this->getCache_ValidatorService())));
    ...
    protected function getVichUploader_MetadataReaderService()
    {
        ...
        $b->setCache(new \Metadata\Cache\FileCache((\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/vich_uploader')));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.debug' => false,
            'kernel.cache_dir' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod'),
            ...
            'kernel.bundles_metadata' => [
                ...
                'StofDoctrineExtensionsBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'stof'.\DIRECTORY_SEPARATOR.'doctrine-extensions-bundle'),
            ...
            'session.save_path' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/sessions'),
            'session.metadata.update_threshold' => 0,
            'form.type_extension.csrf.enabled' => true,
            'form.type_extension.csrf.field_name' => '_token',
            'asset.request_context.base_path' => NULL,
            'asset.request_context.secure' => NULL,
            'validator.mapping.cache.file' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/validation.php'),
            ...
            'serializer.mapping.cache.file' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/serialization.php'),
            'twig.form.resources' => [
            ...
            'doctrine.orm.proxy_dir' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/doctrine/orm/Proxies'),
