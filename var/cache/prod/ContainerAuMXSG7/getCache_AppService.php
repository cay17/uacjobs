...
class getCache_AppService extends App_KernelProdContainer
{
    ...
    {
        $container->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OAsMVLM+Sd', 0, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'prod/pools'), ($container->privates['cache.default_marshaller'] ?? ($container->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
