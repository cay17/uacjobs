 ...
 */
class getAnnotatedAppEntityMedicamentsApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService extends App_KernelProdContainer
{
    /*
     * Gets the private 'annotated_app_entity_medicaments_api_platform_core_bridge_doctrine_orm_filter_boolean_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_medicaments_api_platform_core_bridge_doctrine_orm_filter_boolean_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\BooleanFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ['pharmacies.status_abonnement' => NULL], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
