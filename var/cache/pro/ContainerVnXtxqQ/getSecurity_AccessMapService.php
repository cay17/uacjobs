 ...
 */
class getSecurity_AccessMapService extends App_KernelProDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/etudiant'), [0 => 'ROLE_ETUDIANT', 1 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/recruteur'), [0 => 'ROLE_RECRUTEUR', 1 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_EDITEUR'], NULL);
