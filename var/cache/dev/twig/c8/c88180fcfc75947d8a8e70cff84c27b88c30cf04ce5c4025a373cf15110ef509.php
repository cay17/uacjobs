...
class __TwigTemplate_59ecb4a5dbce29392086576fe0b3d92f6b9216bdcc472f247a0e1f8e42aabfb1 extends Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"actualites d-md-flex d-block px-4 rounded-15 my-5\"
                 style=\"background-color: rgba(42,140,40,0.09)\">
                  <div class=\"d-flex flex-column justify-content-around\">
                        ...
                        <div class=\"d-lg-flex d-block m-3 justify-content-between\">
                              <span class=\"h6 font-weight-bold text-custom font-weight-bold mb-4\">22 dec 2020, 17h30</span>
                              <a href=\"{{ path('article') }}\" class=\"btn bg-primary text-white mt-md-0 mt-3\">Lire l'article</a>
                        </div>
                  </div>
            </div>
            <div class=\"actualites d-md-flex d-block px-4 rounded-15 my-5\"
                 style=\"background-color: rgba(42,140,40,0.09)\">
                  <div class=\"d-flex flex-column justify-content-around\">
                        ...
                        <div class=\"d-lg-flex d-block m-3 justify-content-between\">
                              <span class=\"h6 font-weight-bold text-custom font-weight-bold mb-4\">22 dec 2020, 17h30</span>
                              <a href=\"{{ path('article') }}\" class=\"btn bg-primary text-white\">Lire l'article</a>
                        </div>
                  </div>
            </div>
            <div class=\"actualites d-md-flex d-block px-4 rounded-15 my-5\"
