...
class __TwigTemplate_e154eaac5f511132099d3063319cae10fe462de9362cc4ed4fe53fdbb17e4323 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav class=\"navbar p-0 navbar-expand-xl d-flex justify-content-between align-items-center\">
        ...
        echo "\" class=\"img-fluid rounded-circle\" width=\"40\"/>
                    ...
                    <ul class=\"dropdown-menu w-100\" aria-labelledby=\"dropdownMenuLink3\">
                        <li class=\"text-dark\"><a class=\"dropdown-item \" href=\"";
        // line 100
        echo ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 100, $this->source); })()), "request", [], "any", false, false, false, 100), "attributes", [], "any", false, false, false, 100), "get", [0 => "_route"], "method", false, false, false, 100), "etu_soumissions")) ? ("#") : ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("etu_soumissions")));
        echo "\">Mes
                                soumissions</a></li>
                        <li><a class=\"dropdown-item \" href=\"";
        // line 102
        echo ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 102, $this->source); })()), "request", [], "any", false, false, false, 102), "attributes", [], "any", false, false, false, 102), "get", [0 => "_route"], "method", false, false, false, 102), "etu_profil")) ? ("#") : ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("etu_profil")));
        echo "\">Mon profil</a>
                        </li>
...
";
    ...
    {
        return array (  420 => 165,  402 => 112,  383 => 27,  365 => 7,  354 => 166,  352 => 165,  348 => 164,  343 => 162,  339 => 161,  332 => 157,  327 => 155,  322 => 153,  318 => 152,  313 => 150,  308 => 148,  303 => 146,  297 => 143,  293 => 142,  289 => 141,  277 => 132,  271 => 129,  254 => 114,  252 => 112,  239 => 102,  234 => 100,  226 => 95,  216 => 90,  210 => 89,  203 => 85,  198 => 83,  193 => 81,  178 => 73,  172 => 70,  168 => 69,  154 => 60,  148 => 57,  144 => 56,  139 => 54,  128 => 46,  120 => 45,  111 => 39,  98 => 28,  96 => 27,  86 => 20,  81 => 18,  76 => 16,  71 => 14,  66 => 12,  61 => 10,  55 => 7,  47 => 1,);
    }
