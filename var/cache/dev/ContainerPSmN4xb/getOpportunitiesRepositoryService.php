 ...
 */
class getOpportunitiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OpportunitiesRepository' shared autowired service.
     *
     * @return \App\Repository\OpportunitiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OpportunitiesRepository.php';

        return $container->privates['App\\Repository\\OpportunitiesRepository'] = new \App\Repository\OpportunitiesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
