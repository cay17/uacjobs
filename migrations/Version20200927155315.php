 ...
 */
final class Version20200927155315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pharmacie AS SELECT id FROM pharmacie');
        $this->addSql('DROP TABLE pharmacie');
        $this->addSql('CREATE TABLE pharmacie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, pharmacies_id INTEGER NOT NULL, CONSTRAINT FK_5FC194346DA819FC FOREIGN KEY (pharmacies_id) REFERENCES pharmacies (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO pharmacie (id) SELECT id FROM __temp__pharmacie');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pharmacie AS SELECT id FROM pharmacie');
        $this->addSql('DROP TABLE pharmacie');
        $this->addSql('CREATE TABLE pharmacie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('INSERT INTO pharmacie (id) SELECT id FROM __temp__pharmacie');
        $this->addSql('DROP TABLE __temp__pharmacie');
    }
}
