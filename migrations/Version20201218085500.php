 ...
 */
final class Version20201218085500 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, picture_id, name, lastname, status, mail, slug, biographie, linkedin, facebook, twitter, entreprise, password, is_verified FROM users');
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, picture_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, lastname VARCHAR(255) NOT NULL COLLATE BINARY, status BOOLEAN NOT NULL, mail VARCHAR(255) DEFAULT NULL COLLATE BINARY, slug VARCHAR(255) DEFAULT NULL COLLATE BINARY, biographie CLOB DEFAULT NULL COLLATE BINARY, linkedin VARCHAR(255) DEFAULT NULL COLLATE BINARY, facebook VARCHAR(255) DEFAULT NULL COLLATE BINARY, twitter VARCHAR(255) DEFAULT NULL COLLATE BINARY, entreprise VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_verified BOOLEAN NOT NULL, password CLOB DEFAULT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , CONSTRAINT FK_1483A5E9EE45BDBF FOREIGN KEY (picture_id) REFERENCES media_object (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO users (id, picture_id, name, lastname, status, mail, slug, biographie, linkedin, facebook, twitter, entreprise, password, is_verified) SELECT id, picture_id, name, lastname, status, mail, slug, biographie, linkedin, facebook, twitter, entreprise, password, is_verified FROM __temp__users');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_32FFA373F98F144A ON partenaire (logo_id)');
        $this->addSql('DROP INDEX UNIQ_1483A5E9EE45BDBF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, picture_id, name, lastname, status, mail, password, slug, biographie, linkedin, facebook, twitter, entreprise, is_verified FROM users');
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, picture_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, status BOOLEAN NOT NULL, mail VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, biographie CLOB DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, facebook VARCHAR(255) DEFAULT NULL, twitter VARCHAR(255) DEFAULT NULL, entreprise VARCHAR(255) DEFAULT NULL, is_verified BOOLEAN NOT NULL, password CLOB DEFAULT NULL COLLATE BINARY, role VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO users (id, picture_id, name, lastname, status, mail, password, slug, biographie, linkedin, facebook, twitter, entreprise, is_verified) SELECT id, picture_id, name, lastname, status, mail, password, slug, biographie, linkedin, facebook, twitter, entreprise, is_verified FROM __temp__users');
        $this->addSql('DROP TABLE __temp__users');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E9EE45BDBF ON users (picture_id)');
    }
}
