 ...
 */
final class Version20201217111653 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, picture_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, status BOOLEAN NOT NULL, role VARCHAR(255) NOT NULL, mail VARCHAR(255) DEFAULT NULL, password CLOB DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, biographie CLOB DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, facebook VARCHAR(255) DEFAULT NULL, twitter VARCHAR(255) DEFAULT NULL, entreprise VARCHAR(255) DEFAULT NULL)');
