 ...
 */
final class Version20201218100223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, picture_id, name, lastname, status, mail, slug, biographie, linkedin, facebook, twitter, entreprise, is_verified, password, roles FROM users');
        ...
        $this->addSql('INSERT INTO users (id, picture_id, name, lastname, status, mail, slug, biographie, linkedin, facebook, twitter, entreprise, is_verified, password, roles) SELECT id, picture_id, name, lastname, status, mail, slug, biographie, linkedin, facebook, twitter, entreprise, is_verified, password, roles FROM __temp__users');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, picture_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , mail VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, biographie CLOB DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, facebook VARCHAR(255) DEFAULT NULL, twitter VARCHAR(255) DEFAULT NULL, entreprise VARCHAR(255) DEFAULT NULL, is_verified BOOLEAN NOT NULL, status BOOLEAN NOT NULL, password CLOB DEFAULT NULL COLLATE BINARY)');
